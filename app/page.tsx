    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <Card style={{ borderColor: `${S.success}30`, background: `linear-gradient(135deg, ${S.success}10, ${S.bg})` }}>
        ...
        <div style={{ display: "flex", gap: 32, flexWrap: "wrap" as const, alignItems: "center" }}>
          ...
          <div><p style={{ color: S.muted, fontSize: 12, margin: "0 0 4px" }}>Solde ajust̩</p><EditableAmt value={(m as unknown as Record<string,number>).income_solde_ajuste ?? 0} onChange={v => onIncomeChange("income_solde_ajuste" as "income_other", v)} color={S.muted} size="sm" /></div>
