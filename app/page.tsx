      ...
      <header className="app-header" style={{ background: S.surface, borderBottom: `1px solid ${S.border}`, display: "flex", alignItems: "stretch", position: "sticky", top: 0, zIndex: 40 }}>
        ...
        <div className="header-tools" style={{ display: "flex", alignItems: "center", gap: 5, padding: "0 14px", borderLeft: `1px solid ${S.border}` }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            {showAlerts && <div style={{ position: isMobile ? "fixed" as any : "absolute" as any, top: isMobile ? 50 : 38, right: isMobile ? 10 : 0, left: isMobile ? 10 : "auto", width: isMobile ? "auto" : 300, maxHeight: isMobile ? "60vh" : 400, overflowY: "auto" as const, maxHeight: 380, overflowY: "auto", background: S.surface, border: "none", borderRadius: 16, boxShadow: "0 12px 40px rgba(0,0,0,0.15)", zIndex: 100, padding: 8 }}>
